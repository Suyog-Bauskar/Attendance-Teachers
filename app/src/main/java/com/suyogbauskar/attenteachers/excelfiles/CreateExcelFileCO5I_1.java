...
public class CreateExcelFileCO5I_1 extends Service {
    ...
    private void getAllStudentsData() {
        ...
        rollNoQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                sendErrorNotification(error.getMessage(), 31);
            }
        });
    }
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        FirebaseDatabase.getInstance().getReference("attendance/CO5I-1/" +
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (!snapshot.exists()) {
                                    sendErrorNotification("No attendance found of CO5I-1 " + year, 32);
                                    return;
                                }
                                int counter = 0;
                                ...
                                sendNotificationOfExcelFileCreated(31);
                                stopService(new Intent(getApplicationContext(), CreateExcelFileCO5I_1.class));
                            }

                            @Override
                            public void onCancelled(@NonNull DatabaseError error) {
                                sendErrorNotification(error.getMessage(), 33);
                            }
                        });
                    }
                    ...
                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        sendErrorNotification(error.getMessage(), 34);
                    }
                });
    }
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        try {
                            ...
                            sendErrorNotification(e.getMessage(), 35);
                        }
                        ...
                        try {
                            ...
                            sendErrorNotification(e.getMessage(),36);
                        }
                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        sendErrorNotification(error.getMessage(), 37);
                    }
                });
    }
    ...
    private void fillStaticData() {
        ...
        for (Map.Entry<String, Map<String, Map<String, Map<String, Object>>>> entry1 : allMonthsAndChildren.entrySet()) {
            ...
            try {
                ...
                sendErrorNotification(e.getMessage(), 38);
                return;
            }
    ...
    private void sendNotificationOfExcelFileCreated(int id) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "File")
                ...
                .setContentText("Excel file of CO5I-1 saved in downloads folder")
                .setStyle(new NotificationCompat.BigTextStyle()
                        .bigText("Excel file of CO5I-1 saved in downloads folder"))
