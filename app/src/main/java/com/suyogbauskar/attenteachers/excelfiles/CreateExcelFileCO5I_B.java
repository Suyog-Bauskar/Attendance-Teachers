...
public class CreateExcelFileCO5I_B extends Service {
        ...
        FirebaseDatabase.getInstance().getReference("teachers_data/" + user.getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        FirebaseDatabase.getInstance().getReference("attendance/CO5I-B/" +
    ...
    private void writeExcelDataToFile(String year) {
        FirebaseDatabase.getInstance().getReference("teachers_data/" + user.getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        String filename = snapshot.child("subject_name").getValue(String.class) + " CO5I-B Attendance " + year;
    ...
    private void sendNotificationOfExcelFileCreated(int id) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "File")
                ...
                .setContentText("Excel file of CO5I-B saved in downloads folder")
                .setStyle(new NotificationCompat.BigTextStyle()
                        .bigText("Excel file of CO5I-B saved in downloads folder"))
