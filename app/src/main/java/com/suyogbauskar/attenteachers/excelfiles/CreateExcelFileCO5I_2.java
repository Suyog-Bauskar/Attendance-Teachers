...
public class CreateExcelFileCO5I_2 extends Service {
    ...
    private void getAllStudentsData() {
        ...
        rollNoQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                sendErrorNotification(error.getMessage(), 41);
            }
        });
    }
        ...
        FirebaseDatabase.getInstance().getReference("teachers_data/" + user.getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        FirebaseDatabase.getInstance().getReference("attendance/CO5I-2/" +
                                        snapshot.child("subject_code").getValue(String.class) + "/" + year)
                                .addListenerForSingleValueEvent(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        if (!snapshot.exists()) {
                                            sendErrorNotification("No attendance found of CO5I-2 " + year, 42);
                                            return;
                                        }
                                        int counter = 0;
                                        ...
                                        sendNotificationOfExcelFileCreated(41);
                                        stopService(new Intent(getApplicationContext(), CreateExcelFileCO5I_2.class));
                                    }

                                    @Override
                                    public void onCancelled(@NonNull DatabaseError error) {
                                        sendErrorNotification(error.getMessage(), 43);
                                    }
                                });
                    }
                    ...
                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        sendErrorNotification(error.getMessage(), 44);
                    }
                });
    }
    ...
    private void writeExcelDataToFile(String year) {
        FirebaseDatabase.getInstance().getReference("teachers_data/" + user.getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        String filename = snapshot.child("subject_name").getValue(String.class) + " CO5I-2 Attendance " + year;

                        try {
                            File dir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/Atten Teachers");
                            dir.mkdir();
                        } catch (Exception e) {
                            sendErrorNotification(e.getMessage(), 45);
                        }
                        ...
                        try {
                            ...
                            sendErrorNotification(e.getMessage(), 46);
                        }
                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        sendErrorNotification(error.getMessage(), 47);
                    }
                });
    }
    ...
    private void fillStaticData() {
        ...
        for (Map.Entry<String, Map<String, Map<String, Map<String, Object>>>> entry1 : allMonthsAndChildren.entrySet()) {
            ...
            try {
                ...
                sendErrorNotification(e.getMessage(), 48);
                return;
            }
    ...
    private void sendNotificationOfExcelFileCreated(int id) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "File")
                ...
                .setContentText("Excel file of CO5I-2 saved in downloads folder")
                .setStyle(new NotificationCompat.BigTextStyle()
                        .bigText("Excel file of CO5I-2 saved in downloads folder"))
